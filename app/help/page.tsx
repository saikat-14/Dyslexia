...
export default function HelpPage() {
  const faqs = [
    {
      question: "What is DyslexiAid?",
      answer: "DyslexiAid is a web application that converts regular text into dyslexia-friendly format. It uses specialized fonts, optimized spacing, and improved text structure to make reading easier for individuals with dyslexia."
    },
    {
    ...
    {
      question: "Is DyslexiAid free to use?",
      answer: "Yes! DyslexiAid is completely free to use. We believe that accessibility tools should be available to everyone who needs them."
    },
    {
      question: "What browsers are supported?",
      answer: "DyslexiAid works on all modern browsers including Chrome, Firefox, Safari, and Edge. We recommend using the latest version of your browser for the best experience."
    },
    {
      question: "Can I use this for educational purposes?",
      answer: "Absolutely! DyslexiAid is perfect for educators, students, and anyone who wants to make reading materials more accessible. You can convert textbooks, articles, assignments, and more."
    }
  ]
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">DyslexiAid</h1>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Find answers to common questions and learn how to get the most out of DyslexiAid
          </p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <p className="text-gray-600">
                  <span className="font-medium">Email:</span> support@dyslexiaid.com
                </p>
                <p className="text-gray-600">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary-50 to-blue-50 rounded-2xl p-8 border border-primary-200">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Now that you know how DyslexiAid works, try it out for yourself! 
