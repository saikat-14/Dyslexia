...
export default function TextConverter({ onConvert }: TextConverterProps) {
  ...
  const sampleTexts = [
    "The quick brown fox jumps over the lazy dog. This is a sample text to demonstrate how DyslexiAid can improve readability for people with dyslexia.",
    ...
    "Welcome to DyslexiAid! This application transforms regular text into a more accessible format that's easier to read and understand."
  ]
